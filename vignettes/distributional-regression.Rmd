...
The cumulative coverage rates fluctuate across the time index, revealing periods where the model is overconfident or conservative, before stabilizing closer to nominal levels.
