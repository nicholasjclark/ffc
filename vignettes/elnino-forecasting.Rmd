...
We can use `plot_predictions()` from `marginaleffects` for quick and effortless effect plots on the outcome scale. For example, the below plot shows how our model's fitted seasonal shapes vary over time:
