...
```{r basis-check}
# Check if basis dimensions are adequate
gam.check(mod)
```

The basis dimensions appear adequate (k-index values close to 1, p-values not significant), indicating our smooths have sufficient flexibility.
