...
# Extract forecasted rates for visualization
newdata_forecast$forecasted_rate <- as.numeric(mortality_forecasts)

# Visualization
ggplot(newdata_forecast, aes(x = age, y = forecasted_rate, group = year, color = year)) +
  geom_line(size = 1) +
  facet_wrap(~sex) +
...
This comprehensive forecasting approach enables prediction of entire functional relationships by combining time series forecasts of the functional coefficients with the underlying model structure.
