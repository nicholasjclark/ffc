...
```{r mortality-preview, warning=FALSE, fig.alt="Preview of Queensland mortality data showing characteristic J-shaped curves that shift systematically over time, demonstrating functional evolution suitable for ffc modeling."}
